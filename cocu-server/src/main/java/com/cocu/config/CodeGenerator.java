...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir")+"/cocu-admin-server";
        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setAuthor("Ryanangry");
        gc.setOpen(false);
        ...
        // ⼀、修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/cocu?useUnicode=true&characterEncoding=UTF8&useSSL=false");
